...
public class MainClass {
	...
	InterruptedException {
		...
		FileInputFormat.setInputPaths(job10, new Path("/Job5/job5output-r-00000"), new Path("/Job9/job9output-r-00000"), new Path("/Job9/job9output-r-00001"), new Path("/Job9/job9output-r-00002"), new Path("/Job9/job9output-r-00003"), new Path("/Job9/job9output-r-00004"));
		...
		FileInputFormat.setInputPaths(job11, new Path("/Job10/job10output-r-00000"), new Path("/Job10/job10output-r-00001"), new Path("/Job10/job10output-r-00002"), new Path("/Job10/job10output-r-00003"), new Path("/Job10/job10output-r-00004"), new Path("/Job10/job10output-r-00005"), new Path("/Job10/job10output-r-00006"), new Path("/Job10/job10output-r-00007"), new Path("/Job10/job10output-r-00008"), new Path("/Job10/job10output-r-00009"));
		...
		FileInputFormat.setInputPaths(job12, new Path("/Job10/job10output-r-00000"), new Path("/Job10/job10output-r-00001"), new Path("/Job10/job10output-r-00002"), new Path("/Job10/job10output-r-00003"), new Path("/Job10/job10output-r-00004"), new Path("/Job10/job10output-r-00005"), new Path("/Job10/job10output-r-00006"), new Path("/Job10/job10output-r-00007"), new Path("/Job10/job10output-r-00008"), new Path("/Job10/job10output-r-00009"));
